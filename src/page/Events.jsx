...
<div className="relative">
  ...
  <button
    ...
    className="absolute top-8 right-8 px-4 py-2 bg-zinc-500 text-white rounded-lg shadow-md z-10"
  >
    {showFilter ? 'Hide Filters' : 'Show Filters'}
  </button>

  
  <div className="absolute top-16 right-8 bg-white shadow-lg p-4 rounded-lg">
    {showFilter && (
